...
from nemo.collections.nlp.models.language_modeling.megatron_gpt_prompt_learning_cot_model import (
    MegatronGPTPromptLearningCOTModel,
)
...
@hydra_runner(config_path="conf", config_name="megatron_gpt_prompt_learning_cot_config")
def main(cfg) -> None:
